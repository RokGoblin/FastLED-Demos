...
#define LED_DT D5                                                               //G! modified from 12 // Data pin to connect to the strip.
//#define LED_CK 11                                                             //G! commented out  // Clock pin for WS2801 or APA102.
#define COLOR_ORDER GRB                                                         //G! modified from BGR // It's GRB for WS2812 and BGR for APA102.
#define LED_TYPE WS2811                                                         //G! modified from APA102 // Using APA102, WS2812, WS2801. Don't forget to modify LEDS.addLeds to suit.
#define NUM_LEDS 50                                                             //G! modified from 60 // Number of LED's.

// Fixed sound hardware definitions cannot change on the fly.
#define MIC_PIN    D6                                                           //G! modified from 5 // Microphone on A5.
#define POT_PIN    D7                                                           //G! modified from 4 // Potentiometer on A4.
...
//G! Wi-Fi Start
  /*
    ...
    const char* ssid     = "SparkleTown";
    const char* password = "F1sh.wish.b0ne";
...
int value = 0;
      ...
      Serial.println();
//      Serial.println("closing connection");  //G! commented

//G! Wi-Fi End

// Soundmems Stuff starts
...
// Additional routines modified by G!
...
SimplePatternList gPatterns = {pixels, fillnoise, jugglep, ripple, pixel, matrix, onesine, Gsine, noisefire, Gnoisefireshizz, rainbowbit, noisefiretest, rainbowg, noisewide, plasma, besin, noisepal};  // HERE IS WHERE YOU ADD YOUR ROUTINE TO THE LIST!!!!
//SimplePatternList gPatterns = {rainbowg};  //G! testing
...
//  showfps();                                                                  // Show the frames per second. It had better not dip too far.
  ...
  EVERY_N_SECONDS(30) {                                                         //G! changed from 10 // Change the current pattern function periodically.
    nextPattern();
  }
