...
// G! Defining data pins for LED strips on ESP8266

#define LED_DT1 14                                                              //G! D5 for USBC 14 for Feather Huzzah // Data pin to connect to the strip.
//#define LED_CK 11                                                               // Clock pin for WS2801 or APA102.
#define COLOR_ORDER GRB                                                         // It's GRB for WS2812 and BGR for APA102.
#define LED_TYPE WS2811                                                         // Using APA102, WS2812, WS2801. Don't forget to modify LEDS.addLeds to suit.
#define NUM_LEDS 50                                                             // Number of LED's.

// Fixed sound hardware definitions cannot change on the fly.
#define MIC_PIN    12                                                            //G! Mic on D6 or 12 (Huzzah)// Microphone on A5. (19)
#define POT_PIN    13                                                            //G! Pot on D7 or 13 (Huzzah)// Potentiometer on A4. (18)
//#define BUT_PIN   A3                                                           // Button on A3. (17)

// Global FastLED variables
uint8_t max_bright = 100;                                                       // Maximum brightness, does change in other programs.
...
SimplePatternList gPatterns = {Gsine, Gnoisefireshizz, pixels, fillnoise, jugglep, ripple, pixel, matrix, onesine, noisefire, rainbowbit, noisefiretest, rainbowg, noisewide, plasma, besin, noisepal};  // HERE IS WHERE YOU ADD YOUR ROUTINE TO THE LIST!!!!
