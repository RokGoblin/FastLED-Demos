...
// G! added a bunch of strips that are mirroring the output of the first strip
//    /*
...
//SimplePatternList gPatterns = {plasma};  //G! for testing a single pattern // HERE IS WHERE YOU ADD YOUR ROUTINE TO THE LIST!!!!
...
//  showfps();                                                                  // Show the frames per second. It had better not dip too far.
  ...
  EVERY_N_SECONDS(10) {                //G! originally 10 sec                     // Change the current pattern function periodically.
    nextPattern();
  }
