...
void Gripple() {                                                                 // Display ripples triggered by peaks.
...
// Persistent local variables.
  ...
  switch (step) {
    ...
    case -1:                                                                    // Initialize ripple variables. By Andrew Tuline.
      center = random(NUM_LEDS);   //G! commented out
    ...
    default:                                                                    // Middle of the ripples.
      ...
      leds[(center - step + NUM_LEDS) % NUM_LEDS] += ColorFromPalette(currentPalette, colour, 255/step*2, currentBlending);  //G! commented out // A spreading and fading pattern down the strand.
      step ++;                                                                  // Next step.
      break;  
