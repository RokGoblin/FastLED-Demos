 ...
 * 
 * Does some simple peak detection based on a number of samples. Peaks then trigger a ripple.  This different from fht_log_ripple in that it responds to ANY peak and not just low frequency ones.
 * 
 * 
