...
//
// G! Slave Board Configuration
// G! removing anything that processes data or does anything other than send signal to LED strips

#include <OctoWS2811.h>
/*  //G! commented (slave board)  
...
void setup() {
    pinMode(12, INPUT_PULLUP);  //G! added suggestion from KurtE, trying to setup master/slave
...
//  soundmems();  //G! commented (slave board)
...
*/  //G! commented (slave board)
// wait for Sync signal  //G! added suggestion from KurtE, trying to setup master/slave
//   while (!digitalReadFast(12)) ;  //G! added suggestion from KurtE, trying to setup master/slave
