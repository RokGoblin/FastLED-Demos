...
// G! adding multiple LED strips for Octo WS2811/Teensy 3.2 combo
//    /*
...
//    */
  ...
  set_max_power_in_volts_and_milliamps(5, 1200);                                 // FastLED Power management set at 5V, 500mA.
...
// G! single pattern testing
//SimplePatternList gPatterns = {Gnoisefireshizz};  // HERE IS WHERE YOU ADD YOUR ROUTINE TO THE LIST!!!!
