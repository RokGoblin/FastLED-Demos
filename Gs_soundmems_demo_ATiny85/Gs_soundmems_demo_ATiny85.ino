...
#define MIC_PIN    1                                                            // Microphone on A5.
#define POT_PIN    2                                                            // Potentiometer on A4.
...
#include "Gnoisefireshizz.h"          // G! modification copied from noisefiretest
#include "Gripple.h"        // G! modifications copied from ripple
...
SimplePatternList gPatterns = {Gsine};  // HERE IS WHERE YOU ADD YOUR ROUTINE TO THE LIST!!!!
