...
// G! This configuration is intended to operate as a stand alone system, just power and walk away
// G! OctoWS2811 board paired with Teensy 3.2 in a Master/Slave configuration to sync multiple Octo/Teensy boards
//
// G! Master Board Configuration
...
#define LED_HEIGHT  8  // G added, for VideoDisplay.ino config, trying to get master/slave and pixel mapping working
// #define LED_LAYOUT  1  // G! added, for VideoDisplay.ino config ZigZag RL-LR order, not using Zig zag so commented out
#define VIDEO_XOFFSET  0  // G! added
#define VIDEO_YOFFSET  0  // G! added     // display entire image (single Teensy)
#define VIDEO_WIDTH    100  // G! added
#define VIDEO_HEIGHT   100  // G! added
...
// #define BUT_PIN    A3      // G! No button code yet                           // Button on A3. (17)
...
void setup() {
    pinMode(12, OUTPUT);  //G! added suggestion from KurtE, trying to setup master/slave
    digitalWriteFast(12, HIGH);  //G! added suggestion from KurtE, trying to setup master/slave 
...
//  showfps();                                                                  // Show the frames per second. It had better not dip too far.
  ...
  EVERY_N_SECONDS(5) {                                                          // Change the target palette to a 'related colours' palette every 5 seconds.
   ...
   digitalWriteFast(12, LOW);  //G! added suggestion from KurtE, trying to setup master/slave 
//   leds.show();  // do your output.  //G! added suggestion from KurtE, trying to setup master/slave 
